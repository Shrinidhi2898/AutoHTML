...
public class MainActivity {
			...
			if(htmlFile.createNewFile() && cssFile.createNewFile())
			{
				...
				for(String layerName : decoded.keySet())
				{
					...
					if(parent.equals("ROOT_REF_WINDOW"))
						{
							 // valX = Integer.parseInt(layerValue.getStyleGuideX());
							 // valY = Integer.parseInt(layerValue.getStyleGuideY());
	...
	private static void computeStyleGuide(Map<String, Layers> decoded,
			Stack<Float> guideX2, Stack<Float> guideY2,
